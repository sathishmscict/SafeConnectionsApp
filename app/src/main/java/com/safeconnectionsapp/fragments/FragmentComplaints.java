                    ...
                    if (error_status == false) {
                        if (record_status == true) {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                //  OrderMaster(String complaintId, String categoryname, String complaintdescr, String complaintDate, String complaintTime) {
                                OrderMaster om = new OrderMaster(c.getString(AllKeys.TAG_COMPLAINT_ID), c.getString(AllKeys.TAG_COMPLAINT_CATEGORYNAME), c.getString(AllKeys.TAG_COMPLAINT_DESCRIPTION), c.getString(AllKeys.TAG_COMPLAINT_DATE), c.getString(AllKeys.TAG_COMPLAINT_TIME));
