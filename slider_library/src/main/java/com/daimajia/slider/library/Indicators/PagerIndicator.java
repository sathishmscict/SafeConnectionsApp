...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener {
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        int color = getResources().getColor(R.color.mDefaultSelectedColor);
        int r = Color.red(color);
        int g = Color.green(color);
        int b = Color.blue(color);

        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(255, 255, 255));
        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(r, g, b));

       /*  color = getResources().getColor(R.color.mDefaultUnSelectedColor);
         r = Color.red(color);
         g = Color.green(color);
         b = Color.blue(color);
*/
        ...
        //mDefaultUnSelectedColor = attributes.getColor(R.styleable.PagerIndicator_unselected_color, Color.argb(r,r,g,b));
